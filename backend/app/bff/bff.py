...
@index_router.post("/base/filter", response_class=HTMLResponse)
...
@index_router.get("/base/search", response_class=JSONResponse)
...
@index_router.get("/base/get_by_ids", response_class=JSONResponse)
