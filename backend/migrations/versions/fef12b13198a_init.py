...
Revision ID: fef12b13198a
Revises: 
Create Date: 2024-11-04 20:59:59.083716
...
def upgrade():
    ...
    op.create_table('order',
                    ...
                    sa.Column('status', sa.Enum('DRAFT', 'WAITING', 'CONFIRMED', 'ASSIGNED', 'DONE', 'CANCELED',
    ...
    op.create_table('move',
                    ...
                    sa.Column('status',
                              sa.Enum('CREATED', 'CONFIRMED', 'WAITING', 'ASSIGNED', 'PROCESSING', 'DONE', 'CANCELED',
    ...
    op.create_table('move_log',
                    sa.Column('type',
                              sa.Enum('RECEIPT', 'SHIPMENT', 'WRITE_OFF', 'LOST', 'FOUND', 'RECLASS_IN', 'RECLASS_OUT',
                                      'PUT_IN', 'PUT_OUT', name='movelogtype'), nullable=False),
                    sa.Column('order_id', sa.Uuid(), nullable=True),
    ...
    op.create_table('suggest',
                    ...
                    sa.Column('priority', sa.Integer(), nullable=False),
                    sa.Column('type',
                              sa.Enum('IN_QUANTITY', 'IN_PRODUCT', 'IN_PACKAGE', 'IN_LOCATION', 'IN_LOT', 'IN_RESOURCE',
