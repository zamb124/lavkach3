...
class OrderTypeBaseScheme(BaseModel):
    ...
    allowed_location_src_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location', title='Allowed locations source')
    exclude_location_src_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location', title='Exclude locations source')
    allowed_location_dest_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location', title='Allowed locations dest')
    ...
    allowed_location_type_src_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location_type', title='Allowed locations type source',)
    exclude_location_type_src_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location_type', title='Exclude locations type source')
    allowed_location_type_dest_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location_type', title='Allowed locations type dest',)
    exclude_location_type_dest_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location_type', title='Exclude locations type dest ')
    ...
    exclude_package_ids: Optional[list[UUID4]] = Field(default=None, module='inventory', model='location', title='Exclude packages dest', form=True)
