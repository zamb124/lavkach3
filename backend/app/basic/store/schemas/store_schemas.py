...
from app.basic.store.models.store_models import SourceType
...
class StoreBaseScheme(BasicModel):
    ...
    source: Optional[SourceType] = Field(default=SourceType.INTERNAL, title='Source', table=True, form=True)
...
class StoreUpdateScheme(StoreBaseScheme):
    title: str = Field(title='Title', table=True, form=True)
    source: Optional[SourceType] = Field(default=None, title='Source', table=True, form=True)
...
class StoreFilter(BaseFilter):
    ...
    source__in: Optional[list[SourceType]] = Field(default=None, title='Source')
