...
from app.basic.user.models.role_models import Role, roles_assotiation
...
down_revision = '9333b140ada7'
branch_labels = None
depends_on = '9333b140ada7'


def upgrade():
    company_1_id = uuid4()
    company_2_id = uuid4()
    store_1_company_1_id = uuid4()
    store_2_company_1_id = uuid4()
    store_3_company_1_id = uuid4()
    store_1_company_2_id = uuid4()
    store_2_company_2_id = uuid4()
    store_3_company_2_id = uuid4()
    user_admin_id = uuid4()
    user_1_company_1_id = uuid4()
    user_2_company_1_id = uuid4()
    user_1_company_2_id = uuid4()
    user_2_company_2_id = uuid4()
    role_1_company_1_id = uuid4()
    role_2_company_1_id = uuid4()
    role_1_company_2_id = uuid4()
    role_2_company_2_id = uuid4()
    ...
    op.bulk_insert(roles_assotiation,
                   [
                       {
                           'parent_role_id': role_2_company_1_id,
                           'child_role_id': role_1_company_1_id,
                           "active": True
                       },
                       {
                           'parent_role_id': role_2_company_2_id,
                           'child_role_id': role_1_company_2_id,
                           "active": True
                       },
...
def downgrade():
    ...
    op.execute(f"TRUNCATE TABLE {roles_assotiation}")
