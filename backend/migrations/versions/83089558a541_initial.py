...
Revision ID: 83089558a541
Revises: 
Create Date: 2023-06-20 19:24:39.838437
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['company_id'], ['company.id'], ),
    sa.ForeignKeyConstraint(['store_id'], ['store.id'], ),
    sa.ForeignKeyConstraint(['supplier_user_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['user_created_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_order_lines_lsn'), 'order_lines', ['lsn'], unique=False)
    ...
    op.execute("create sequence order_lines_lsn_seq")

def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_order_lines_order_id'), table_name='order_lines')
    op.drop_index(op.f('ix_order_lines_lsn'), table_name='order_lines')
    ...
    op.execute("drop sequence order_lines_lsn_seq")