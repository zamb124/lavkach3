...
Revision ID: 7c539bc761d4
Revises: 
Create Date: 2024-04-07 15:05:53.177080
...
def upgrade():
    ...
    op.create_table('location_type',
                    ...
                    sa.Column('product_storage_type_ids', sa.ARRAY(sa.String()), nullable=True),
                    sa.Column('is_homogeneity', sa.Boolean(), nullable=True),
                    sa.Column('is_mix_products', sa.Boolean(), nullable=True),
                    sa.Column('is_allow_create_package', sa.Boolean(), nullable=True),
                    sa.Column('allowed_package_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('exclusive_package_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('allowed_order_type_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('exclusive_order_type_ids', sa.ARRAY(sa.Uuid()), nullable=True),
    ...
    op.create_index(op.f('ix_location_type_allowed_order_type_ids'), 'location_type', ['allowed_order_type_ids'],
                    unique=False)
    ...
    op.create_index(op.f('ix_location_type_exclusive_order_type_ids'), 'location_type', ['exclusive_order_type_ids'],
                    unique=False)
    op.create_index(op.f('ix_location_type_exclusive_package_ids'), 'location_type', ['exclusive_package_ids'],
                    unique=False)
    ...
    op.create_index(op.f('ix_location_type_product_storage_type_ids'), 'location_type', ['product_storage_type_ids'],
                    unique=False)
    op.create_table('lot',
                    sa.Column('id', sa.Uuid(), nullable=False),
    ...
    op.create_table('order_type',
                    ...
                    sa.Column('order_class', sa.Enum('INCOMING', 'OUTGOING', 'INTERNAL', name='orderclass'),
                              nullable=False),
                    sa.Column('allowed_location_src_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('exclusive_location_src_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('allowed_location_dest_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('exclusive_location_dest_ids', sa.ARRAY(sa.Uuid()), nullable=True),
    ...
    op.create_index(op.f('ix_order_type_exclusive_location_dest_ids'), 'order_type', ['exclusive_location_dest_ids'],
                    unique=False)
    op.create_index(op.f('ix_order_type_exclusive_location_src_ids'), 'order_type', ['exclusive_location_src_ids'],
                    unique=False)
    op.create_index(op.f('ix_order_type_exclusive_package_ids'), 'order_type', ['exclusive_package_ids'], unique=False)
    ...
    op.create_table('product_category',
                    ...
                    sa.Column('external_number', sa.String(), nullable=True),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('product_category_ids', sa.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
    ...
    op.create_index(op.f('ix_product_storage_type_title'), 'product_storage_type', ['title'], unique=False)
    op.create_table('role',
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('role_ids', postgresql.ARRAY(sa.Uuid()), nullable=True),
                    sa.Column('permission_allow_list', postgresql.ARRAY(sa.String()), nullable=True),
                    sa.Column('permission_deny_list', postgresql.ARRAY(sa.String()), nullable=True),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
    ...
    op.create_table('move',
                    ...
                    sa.Column('status',
                              sa.Enum('DRAFT', 'WAITING', 'CONFIRMED', 'PARTIALY', 'ASSIGNED', 'DONE', 'CANCELED',
                    ...
                    sa.Column('vars', sqlalchemy_utils.types.json.JSONType(), nullable=True),
                    sa.ForeignKeyConstraint(['company_id'], ['company.id'], ),
                    sa.ForeignKeyConstraint(['location_dest_id'], ['location.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['location_id'], ['location.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['location_src_id'], ['location.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['lot_id'], ['lot.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['move_id'], ['move.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['order_id'], ['order.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['uom_id'], ['uom.id'], ondelete='RESTRICT'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_index(op.f('ix_move_log_location_type_id'), 'move_log', ['location_type_id'], unique=False)
    ...
    op.create_table('product',
                    ...
                    sa.Column('product_storage_type_id', sa.Uuid(), nullable=False),
                    sa.Column('barcode_list', sa.ARRAY(sa.String()), nullable=True),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['product_storage_type_id'], ['product_storage_type.id'], ),
    ...
    op.create_index(op.f('ix_product_product_storage_type_id'), 'product', ['product_storage_type_id'], unique=False)
    ...
    op.create_table('suggest',
                    ...
                    sa.Column('type', sa.Enum('IN_QUANTITY', 'IN_PACKAGE', 'IN_LOCATION', 'IN_RESOURCE', 'IN_VALID',
                                              'NEW_PACKAGE', 'NEW_LOT', name='suggesttype'), nullable=False),
                    sa.Column('value', sa.String(), nullable=True),
                    sa.Column('user_done_id', sa.Uuid(), nullable=True),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
    ...
    op.create_index(op.f('ix_suggest_user_done_id'), 'suggest', ['user_done_id'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_suggest_user_done_id'), table_name='suggest')
    ...
    op.drop_index(op.f('ix_product_product_storage_type_id'), table_name='product')
    ...
    op.drop_table('role')
    op.drop_index(op.f('ix_product_storage_type_title'), table_name='product_storage_type')
    ...
    op.drop_index(op.f('ix_order_type_exclusive_package_ids'), table_name='order_type')
    op.drop_index(op.f('ix_order_type_exclusive_location_src_ids'), table_name='order_type')
    op.drop_index(op.f('ix_order_type_exclusive_location_dest_ids'), table_name='order_type')
    ...
    op.drop_table('lot')
    op.drop_index(op.f('ix_location_type_product_storage_type_ids'), table_name='location_type')
    ...
    op.drop_index(op.f('ix_location_type_exclusive_package_ids'), table_name='location_type')
    op.drop_index(op.f('ix_location_type_exclusive_order_type_ids'), table_name='location_type')
    ...
    op.drop_index(op.f('ix_location_type_allowed_order_type_ids'), table_name='location_type')
