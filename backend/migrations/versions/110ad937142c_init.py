...
Revision ID: 110ad937142c
Revises: 
Create Date: 2024-12-03 12:00:16.342392
...
def upgrade():
    ...
    op.create_table('bus',
                    ...
                    sa.Column('status', sa.Enum('NEW', 'PROCESSING', 'ERROR', 'DELIVERED', name='busstatus'),
                              nullable=False),
                    ...
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=True),
                    sa.Column('vars', sqlalchemy_utils.types.json.JSONType(), nullable=False),
    ...
    op.create_table('lot',
                    ...
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('external_number'),
                    sa.UniqueConstraint('external_number', 'product_id', 'partner_id', name='_lot_ex_pr_par_id_uc')
                    )
    ...
    op.create_table('order_type',
                    ...
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('order_class', sa.Enum('INCOMING', 'OUTGOING', 'INTERNAL', name='orderclass'),
                              nullable=False),
                    sa.Column('allowed_zone_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('allowed_location_type_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('allowed_location_classes', sa.ARRAY(
                        sa.Enum('PARTNER', 'PLACE', 'RESOURCE', 'PACKAGE', 'ZONE', 'LOST', 'INVENTORY', 'SCRAP',
                                'SCRAPPED', name='locationclass')), server_default='{}', nullable=True),
                    sa.Column('order_type_id', sa.Uuid(), nullable=True),
                    sa.Column('backorder_action_type', sa.Enum('ASK', 'ALWAYS', 'NEVER', name='backorderaction'),
                              nullable=False),
                    sa.Column('store_id', sa.Uuid(), nullable=True),
                    sa.Column('partner_id', sa.Uuid(), nullable=True),
                    sa.Column('reservation_method',
                              sa.Enum('AT_CONFIRM', 'MANUAL', 'AT_DATE', 'TIME_BEFORE_DATE', name='reservationmethod'),
                              nullable=False),
                    sa.Column('reservation_time_before', sa.Integer(), nullable=True),
                    sa.Column('allowed_package_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('exclude_package_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    ...
                    sa.Column('strategy', sa.Enum('FEFO', 'FIFO', 'LIFO', 'LEFO', name='putawaystrategy'),
                              nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                    ...
                    sa.ForeignKeyConstraint(['order_type_id'], ['order_type.id'], ondelete='CASCADE'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('title', 'company_id', name='_order_type_companyid_title_uc')
                    )
    op.create_index(op.f('ix_order_type_allowed_location_classes'), 'order_type', ['allowed_location_classes'],
                    unique=False)
    op.create_index(op.f('ix_order_type_allowed_location_type_ids'), 'order_type', ['allowed_location_type_ids'],
                    unique=False)
    op.create_index(op.f('ix_order_type_allowed_package_ids'), 'order_type', ['allowed_package_ids'], unique=False)
    op.create_index(op.f('ix_order_type_allowed_zone_ids'), 'order_type', ['allowed_zone_ids'], unique=False)
    ...
    op.create_index(op.f('ix_order_type_exclude_package_ids'), 'order_type', ['exclude_package_ids'], unique=False)
    ...
    op.create_table('product_category',
                    ...
                    sa.Column('external_number', sa.String(), nullable=True),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('product_category_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
                    ...
                    sa.Column('vars', sqlalchemy_utils.types.json.JSONType(), nullable=False),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('external_number', 'company_id', name='_product_category_company_id_uc')
                    )
    ...
    op.create_index(op.f('ix_product_category_product_category_ids'), 'product_category', ['product_category_ids'],
                    unique=False)
    op.create_index(op.f('ix_product_category_title'), 'product_category', ['title'], unique=False)
    op.create_table('role',
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('role_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False,
                              comment='Список дочерних ролей'),
                    sa.Column('permission_allow_list', postgresql.ARRAY(sa.String()), server_default='{}',
                              nullable=False),
                    sa.Column('permission_deny_list', postgresql.ARRAY(sa.String()), server_default='{}',
                              nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
    ...
    op.create_index(op.f('ix_role_permission_allow_list'), 'role', ['permission_allow_list'], unique=False)
    ...
    op.create_table('storage_type',
                    ...
                    sa.Column('allowed_location_type_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('allowed_zones', sa.JSON(), nullable=True),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
    ...
    op.create_table('store_staff',
                    sa.Column('user_id', sa.Uuid(), nullable=True),
                    sa.Column('staff_position',
                              sa.Enum('STOREKEEPER', 'SENIOR_STOREKEEPER', 'DEPUTY_STORE_MANAGER', 'STORE_MANAGER',
                                      'SUPERVISOR', name='staffposition'), nullable=False),
                    sa.Column('store_id', sa.Uuid(), nullable=True),
                    sa.Column('store_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
    ...
    op.create_index(op.f('ix_store_staff_user_id'), 'store_staff', ['user_id'], unique=True)
    ...
    op.create_table('location_type',
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('store_id', sa.Uuid(), nullable=True),
                    sa.Column('allowed_package_type_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('exclude_package_type_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('is_homogeneity', sa.Boolean(), nullable=True),
                    sa.Column('strategy', sa.Enum('FEFO', 'FIFO', 'LIFO', 'LEFO', name='putawaystrategy'),
                              nullable=True),
                    sa.Column('is_can_negative', sa.Boolean(), server_default=sa.text('false'), nullable=True),
                    ...
                    sa.Column('location_class',
                              sa.Enum('PARTNER', 'PLACE', 'RESOURCE', 'PACKAGE', 'ZONE', 'LOST', 'INVENTORY', 'SCRAP',
                                      'SCRAPPED', name='locationclass'), nullable=False),
                    sa.Column('partner_id', sa.Uuid(), nullable=True),
                    sa.ForeignKeyConstraint(['storage_type_id'], ['storage_type.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_location_type_allowed_package_type_ids'), 'location_type', ['allowed_package_type_ids'],
                    unique=False)
    op.create_index(op.f('ix_location_type_capacity'), 'location_type', ['capacity'], unique=False)
    op.create_index(op.f('ix_location_type_company_id'), 'location_type', ['company_id'], unique=False)
    op.create_index(op.f('ix_location_type_exclude_package_type_ids'), 'location_type', ['exclude_package_type_ids'],
                    unique=False)
    op.create_index(op.f('ix_location_type_id'), 'location_type', ['id'], unique=False)
    op.create_index(op.f('ix_location_type_is_can_negative'), 'location_type', ['is_can_negative'], unique=False)
    op.create_index(op.f('ix_location_type_is_homogeneity'), 'location_type', ['is_homogeneity'], unique=False)
    op.create_index(op.f('ix_location_type_location_class'), 'location_type', ['location_class'], unique=False)
    op.create_index(op.f('ix_location_type_lsn'), 'location_type', ['lsn'], unique=False)
    op.create_index(op.f('ix_location_type_partner_id'), 'location_type', ['partner_id'], unique=False)
    op.create_index(op.f('ix_location_type_storage_type_id'), 'location_type', ['storage_type_id'], unique=False)
    ...
    op.create_table('order',
                    ...
                    sa.Column('expiration_datetime', sa.DateTime(timezone=True), nullable=True),
                    sa.Column('user_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('description', sa.String(), nullable=True),
                    sa.Column('status',
                              sa.Enum('CREATED', 'CONFIRMED', 'WAITING', 'PROCESSING', 'COMPLETE', 'CANCELED', 'FAILED',
                                      name='orderstatus'), nullable=False),
                    sa.Column('estatus', sa.String(), nullable=True),
                    sa.Column('processing_steps', sa.JSON(), nullable=False),
                    sa.Column('id', sa.UUID(), nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                    ...
                    sa.ForeignKeyConstraint(['order_type_id'], ['order_type.id'], ondelete='RESTRICT'),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('external_number', 'company_id', name='_order_companyid_external_number_uc')
                    )
    ...
    op.create_index(op.f('ix_order_estatus'), 'order', ['estatus'], unique=False)
    ...
    op.create_table('product_storage_type',
                    ...
                    sa.Column('allowed_storage_uom_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('allowed_package_type_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('storage_image_url', sa.String(), nullable=True),
                    sa.Column('is_homogeneity', sa.Boolean(), nullable=False),
                    sa.Column('storage_type_id', sa.Uuid(), nullable=False),
                    sa.Column('id', sa.UUID(), nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                    ...
                    sa.ForeignKeyConstraint(['storage_type_id'], ['storage_type.id'], ),
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('product_id', 'company_id', name='stor_type_product_company_id_uc')
                    )
    op.create_index(op.f('ix_product_storage_type_company_id'), 'product_storage_type', ['company_id'], unique=False)
    op.create_index(op.f('ix_product_storage_type_id'), 'product_storage_type', ['id'], unique=False)
    op.create_index(op.f('ix_product_storage_type_is_homogeneity'), 'product_storage_type', ['is_homogeneity'],
                    unique=False)
    op.create_index(op.f('ix_product_storage_type_lsn'), 'product_storage_type', ['lsn'], unique=False)
    op.create_index(op.f('ix_product_storage_type_product_id'), 'product_storage_type', ['product_id'], unique=False)
    op.create_table('uom',
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('title', sa.String(), nullable=False),
    ...
    op.create_table('user',
                    ...
                    sa.Column('company_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('role_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
    ...
    op.create_table('location',
                    ...
                    sa.Column('block', sa.Enum('FULL_BLOCK', 'MOVE_BLOCK', 'PRODUCT_BLOCK', 'FREE', name='blockerenum'),
                              nullable=False),
    ...
    op.create_index(op.f('ix_location_block'), 'location', ['block'], unique=False)
    ...
    op.create_index(op.f('ix_location_location_class'), 'location', ['location_class'], unique=False)
    op.create_index(op.f('ix_location_location_id'), 'location', ['location_id'], unique=False)
    op.create_index(op.f('ix_location_location_type_id'), 'location', ['location_type_id'], unique=False)
    op.create_index(op.f('ix_location_lsn'), 'location', ['lsn'], unique=False)
    op.create_index(op.f('ix_location_sort'), 'location', ['sort'], unique=False)
    ...
    op.create_table('partner',
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('type', sa.Enum('PARTNER', 'CONTACT', 'SUBPARTNER', 'INTERCOMPANY', 'STORE', 'USER',
    ...
    op.create_table('product',
                    ...
                    sa.Column('barcode_list', postgresql.ARRAY(sa.String()), server_default='{}', nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
                    ...
                    sa.PrimaryKeyConstraint('id'),
                    sa.UniqueConstraint('external_number', 'company_id', name='_product_company_id_uc')
                    )
    ...
    op.create_index(op.f('ix_product_product_category_id'), 'product', ['product_category_id'], unique=False)
    ...
    op.create_index(op.f('ix_location_log_block'), 'location_log', ['block'], unique=False)
    op.create_index(op.f('ix_location_log_company_id'), 'location_log', ['company_id'], unique=False)
    op.create_index(op.f('ix_location_log_id'), 'location_log', ['id'], unique=False)
    op.create_index(op.f('ix_location_log_location_class'), 'location_log', ['location_class'], unique=False)
    op.create_index(op.f('ix_location_log_location_id'), 'location_log', ['location_id'], unique=False)
    op.create_index(op.f('ix_location_log_location_type_id'), 'location_log', ['location_type_id'], unique=False)
    op.create_index(op.f('ix_location_log_lsn'), 'location_log', ['lsn'], unique=False)
    op.create_index(op.f('ix_location_log_store_id'), 'location_log', ['store_id'], unique=False)
    op.create_index(op.f('ix_location_log_title'), 'location_log', ['title'], unique=False)
    op.create_table('quant',
                    ...
                    sa.Column('expiration_datetime', sa.DateTime(timezone=True), nullable=True),
                    sa.Column('uom_id', sa.Uuid(), nullable=False),
                    sa.Column('move_ids', postgresql.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['package_id'], ['location.id'], ondelete='RESTRICT'),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_index(op.f('ix_quant_package_id'), 'quant', ['package_id'], unique=False)
    ...
    op.create_table('move',
                    sa.Column('type', sa.Enum('PRODUCT', 'PACKAGE', name='movetype'), nullable=False),
                    ...
                    sa.Column('status',
                              sa.Enum('CREATED', 'CONFIRMED', 'WAITING', 'PROCESSING', 'COMPLETE', 'CANCELED', 'FAILED',
                                      name='movestatus'), nullable=False),
                    sa.Column('estatus', sa.String(), nullable=True),
                    sa.Column('processing_steps', sa.JSON(), nullable=False),
                    sa.Column('id', sa.UUID(), nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    ...
                    sa.Column('created_by', sa.Uuid(), nullable=False),
                    sa.Column('edited_by', sa.Uuid(), nullable=False),
                    sa.ForeignKeyConstraint(['location_dest_id'], ['location.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['location_src_id'], ['location.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['lot_id'], ['lot.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['move_id'], ['move.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['order_id'], ['order.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['order_type_id'], ['order_type.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['package_id'], ['location.id'], ondelete='RESTRICT'),
                    sa.ForeignKeyConstraint(['quant_dest_id'], ['quant.id'], ondelete='NO ACTION'),
                    sa.ForeignKeyConstraint(['quant_src_id'], ['quant.id'], ondelete='NO ACTION'),
                    sa.PrimaryKeyConstraint('id')
                    )
    ...
    op.create_index(op.f('ix_move_estatus'), 'move', ['estatus'], unique=False)
    ...
    op.create_table('move_log',
                    sa.Column('type',
                              sa.Enum('RECEIPT', 'SHIPMENT', 'WRITE_OFF', 'LOST', 'FOUND', 'RECLASS_IN', 'RECLASS_OUT',
                                      'PUT_IN', 'PUT_OUT', 'INVENROTY_IN', 'INVENROTY_OUT', name='movelogtype'),
                              nullable=False),
                    sa.Column('order_id', sa.UUID(), nullable=True),
    ...
    op.create_index(op.f('ix_move_log_created_by'), 'move_log', ['created_by'], unique=False)
    op.create_index(op.f('ix_move_log_edited_by'), 'move_log', ['edited_by'], unique=False)
    op.create_index(op.f('ix_move_log_id'), 'move_log', ['id'], unique=False)
    op.create_index(op.f('ix_move_log_location_class'), 'move_log', ['location_class'], unique=False)
    ...
    op.create_index(op.f('ix_move_log_move_id'), 'move_log', ['move_id'], unique=False)
    op.create_index(op.f('ix_move_log_order_id'), 'move_log', ['order_id'], unique=False)
    ...
    op.create_index(op.f('ix_move_log_type'), 'move_log', ['type'], unique=False)
    op.create_index(op.f('ix_move_log_uom_id'), 'move_log', ['uom_id'], unique=False)
    op.create_table('suggest',
                    sa.Column('move_id', sa.UUID(), nullable=False),
                    sa.Column('priority', sa.Integer(), nullable=False),
                    sa.Column('type',
                              sa.Enum('IN_QUANTITY', 'IN_PRODUCT', 'IN_PACKAGE', 'IN_LOCATION_SRC', 'IN_LOCATION_DEST',
                    ...
                    sa.Column('user_id', sa.Uuid(), nullable=True),
                    sa.Column('status', sa.Enum('WAITING', 'DONE', name='suggeststatus'), nullable=False),
                    sa.Column('id', sa.UUID(), nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_move_log_uom_id'), table_name='move_log')
    op.drop_index(op.f('ix_move_log_type'), table_name='move_log')
    ...
    op.drop_index(op.f('ix_move_log_order_id'), table_name='move_log')
    op.drop_index(op.f('ix_move_log_move_id'), table_name='move_log')
    ...
    op.drop_index(op.f('ix_move_log_edited_by'), table_name='move_log')
    op.drop_index(op.f('ix_move_log_created_by'), table_name='move_log')
    ...
    op.drop_index(op.f('ix_move_estatus'), table_name='move')
    ...
    op.drop_index(op.f('ix_quant_package_id'), table_name='quant')
    ...
    op.drop_table('quant')
    op.drop_index(op.f('ix_location_log_title'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_store_id'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_lsn'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_location_type_id'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_location_id'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_location_class'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_id'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_company_id'), table_name='location_log')
    op.drop_index(op.f('ix_location_log_block'), table_name='location_log')
    ...
    op.drop_index(op.f('ix_location_sort'), table_name='location')
    ...
    op.drop_index(op.f('ix_location_block'), table_name='location')
    ...
    op.drop_index(op.f('ix_product_storage_type_is_homogeneity'), table_name='product_storage_type')
    ...
    op.drop_index(op.f('ix_order_estatus'), table_name='order')
    ...
    op.drop_index(op.f('ix_location_type_storage_type_id'), table_name='location_type')
    ...
    op.drop_index(op.f('ix_location_type_exclude_package_type_ids'), table_name='location_type')
    op.drop_index(op.f('ix_location_type_company_id'), table_name='location_type')
    op.drop_index(op.f('ix_location_type_capacity'), table_name='location_type')
    op.drop_index(op.f('ix_location_type_allowed_package_type_ids'), table_name='location_type')
    ...
    op.drop_index(op.f('ix_order_type_allowed_zone_ids'), table_name='order_type')
    op.drop_index(op.f('ix_order_type_allowed_package_ids'), table_name='order_type')
    op.drop_index(op.f('ix_order_type_allowed_location_type_ids'), table_name='order_type')
    op.drop_index(op.f('ix_order_type_allowed_location_classes'), table_name='order_type')
