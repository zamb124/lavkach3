...
inventory_router.include_router(
    quant_router,
    prefix="/api/inventory/quant",
    tags=["Quant"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    lot_router,
    prefix="/api/inventory/lot",
    tags=["Lot"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    location_type_router,
    prefix="/api/inventory/location_type",
    tags=["LocationType"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    location_router,
    prefix="/api/inventory/location",
    tags=["Location"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    order_router,
    prefix="/api/inventory/order",
    tags=["Order"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    move_router,
    prefix="/api/inventory/move",
    tags=["Order"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    suggest_router,
    prefix="/api/inventory/suggest",
    tags=["Order"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    order_type_router,
    prefix="/api/inventory/order_type",
    tags=["OrderType"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    product_storage_type_router,
    prefix="/api/inventory/product_storage_type",
    tags=["ProductStorageType"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
inventory_router.include_router(
    store_staff_router,
    prefix="/api/inventory/store_staff",
    tags=["StoreStaff"],
    dependencies=[Depends(PermissionDependency([IsAuthenticated]))]
)
