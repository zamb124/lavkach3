...
Revision ID: 221dafa333db
Revises: 
Create Date: 2024-11-11 13:34:03.946688
...
def upgrade():
    ...
    op.create_table('order_type',
                    ...
                    sa.Column('order_class', sa.Enum('INCOMING', 'OUTGOING', 'INTERNAL', name='orderclass'),
                              nullable=False),
                    sa.Column('allowed_location_src_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('exclude_location_src_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('allowed_location_dest_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('exclude_location_dest_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('allowed_location_type_src_ids', sa.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('exclude_location_type_src_ids', sa.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('allowed_location_type_dest_ids', sa.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('exclude_location_type_dest_ids', sa.ARRAY(sa.Uuid()), server_default='{}',
                              nullable=False),
                    sa.Column('allowed_location_class_src_ids', sa.ARRAY(sa.String()), server_default='{}',
                              nullable=False),
                    sa.Column('exclude_location_class_src_ids', sa.ARRAY(sa.String()), server_default='{}',
                              nullable=False),
                    sa.Column('allowed_location_class_dest_ids', sa.ARRAY(sa.String()), server_default='{}',
                              nullable=False),
                    sa.Column('exclude_location_class_dest_ids', sa.ARRAY(sa.String()), server_default='{}',
                              nullable=False),
                    ...
                    sa.Column('allowed_package_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('exclude_package_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
    ...
    op.create_index(op.f('ix_order_type_allowed_location_dest_ids'), 'order_type', ['allowed_location_dest_ids'],
                    unique=False)
    op.create_index(op.f('ix_order_type_allowed_location_src_ids'), 'order_type', ['allowed_location_src_ids'],
                    unique=False)
    ...
    op.create_index(op.f('ix_order_type_exclude_location_dest_ids'), 'order_type', ['exclude_location_dest_ids'],
                    unique=False)
    op.create_index(op.f('ix_order_type_exclude_location_src_ids'), 'order_type', ['exclude_location_src_ids'],
                    unique=False)
    ...
    op.create_table('product_category',
                    ...
                    sa.Column('external_number', sa.String(), nullable=True),
                    sa.Column('title', sa.String(), nullable=False),
                    sa.Column('product_category_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
    ...
    op.create_table('product_storage_type',
                    ...
                    sa.Column('exclude_package_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('is_homogeneity', sa.Boolean(), nullable=False),
                    sa.Column('storage_type_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
    ...
    op.create_table('storage_type',
                    ...
                    sa.Column('location_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
                    sa.Column('company_id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
    ...
    op.create_table('location_type',
                    ...
                    sa.Column('location_class',
                              sa.Enum('PARTNER', 'PLACE', 'RESOURCE', 'PACKAGE', 'ZONE', 'LOST', 'INVENTORY', 'SCRAP',
                                      'SCRAPPED', 'BUFFER', name='locationclass'), nullable=False),
                    sa.Column('lot_id', sa.Uuid(), nullable=True),
                    sa.Column('partner_id', sa.Uuid(), nullable=True),
                    sa.ForeignKeyConstraint(['lot_id'], ['lot.id'], ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_location_type_allowed_package_ids'), 'location_type', ['allowed_package_ids'],
                    unique=False)
    op.create_index(op.f('ix_location_type_company_id'), 'location_type', ['company_id'], unique=False)
    op.create_index(op.f('ix_location_type_exclude_package_ids'), 'location_type', ['exclude_package_ids'],
                    unique=False)
    ...
    op.create_table('order',
                    ...
                    sa.Column('status', sa.Enum('CREATED', 'CONFIRMING', 'RESERVATION_FAILED', 'CONFIRMED', 'WAITING',
                                                'PROCESSING', 'COMPLETING', 'DONE', 'CANCELING', name='orderstatus'),
                              nullable=False),
    ...
    op.create_table('user',
                    ...
                    sa.Column('company_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('role_ids', sa.ARRAY(sa.Uuid()), server_default='{}', nullable=False),
                    sa.Column('created_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
                              nullable=False),
                    sa.Column('updated_at', sa.DateTime(), server_default=sa.text("TIMEZONE('utc', CURRENT_TIMESTAMP)"),
    ...
    op.create_index(op.f('ix_location_allowed_package_ids'), 'location', ['allowed_package_ids'], unique=False)
    op.create_index(op.f('ix_location_company_id'), 'location', ['company_id'], unique=False)
    op.create_index(op.f('ix_location_exclude_package_ids'), 'location', ['exclude_package_ids'], unique=False)
    op.create_index(op.f('ix_location_id'), 'location', ['id'], unique=False)
    op.create_index(op.f('ix_location_is_can_negative'), 'location', ['is_can_negative'], unique=False)
    ...
    op.create_table('quant',
                    ...
                    sa.ForeignKeyConstraint(['location_type_id'], ['location_type.id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(['lot_id'], ['lot.id'], ondelete='SET NULL'),
                    sa.PrimaryKeyConstraint('id'),
    ...
    op.create_table('move',
                    ...
                    sa.Column('status', sa.Enum('CREATED', 'CONFIRMING', 'RESERVATION_FAILED', 'CONFIRMED', 'WAITING',
                                                'PROCESSING', 'COMPLETING', 'DONE', 'CANCELING', name='movestatus'),
                              nullable=False),
                    sa.Column('processing_steps', sa.JSON(), nullable=False),
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('lsn', sa.BigInteger(), nullable=True),
...
def downgrade():
    ...
    op.drop_index(op.f('ix_product_storage_type_exclude_package_ids'), table_name='product_storage_type')
    op.drop_index(op.f('ix_product_storage_type_company_id'), table_name='product_storage_type')
    op.drop_index(op.f('ix_product_storage_type_allowed_package_ids'), table_name='product_storage_type')
