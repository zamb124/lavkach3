...
Revision ID: 955a6511aa0a
Revises: 
Create Date: 2024-11-08 14:14:17.247198
...
def upgrade():
    ...
    op.create_table('suggest',
                    ...
                    sa.Column('priority', sa.Integer(), nullable=False),
                    sa.Column('type',
                              sa.Enum('IN_QUANTITY', 'IN_PRODUCT', 'IN_PACKAGE', 'IN_LOCATION_SRC', 'IN_LOCATION_DEST','IN_LOT', 'IN_RESOURCE',
                                      'IN_VALID', 'NEW_PACKAGE', 'NEW_LOT', name='suggesttype'), nullable=False),
